            ...
            for (int j = 0; j < size_g; j++) {
                if (i + 1 < size_g) {
                    for (int k = 0; k < graph[i][j].getWires().size(); k++) {
                        if (graph[i][j].getWires().get(k).dir == 0) {
                            if (graph[i + 1][j].getWires().get(k+size_w).dir == 1) {
                                graph[i][j].add_edge(graph[i][j].getWires().get(k), graph[i + 1][j].getWires().get(k+size_w), graph[i + 1][j].getWires().get(k+size_w).getCost());
                                graph[i + 1][j].add_edge(graph[i + 1][j].getWires().get(k+size_w), graph[i][j].getWires().get(k), graph[i][j].getWires().get(k).getCost());
                            }
                        }
                        else{
                             if (graph[i + 1][j].getWires().get(k).dir == 1) {
                                graph[i][j].add_edge(graph[i][j].getWires().get(k), graph[i + 1][j].getWires().get(k), graph[i + 1][j].getWires().get(k).getCost());
                                graph[i + 1][j].add_edge(graph[i + 1][j].getWires().get(k), graph[i][j].getWires().get(k), graph[i][j].getWires().get(k).getCost());
                            }
                        }
                    }
                }
                if (j + 1 < size_g) {
                    for (int k = 0; k < graph[i][j].getWires().size(); k++) {
                        if (graph[i][j].getWires().get(k).dir == 0) {
                            if (graph[i][j + 1].getWires().get(k).dir == 0) {
                                graph[i][j].add_edge(graph[i][j].getWires().get(k), graph[i][j + 1].getWires().get(k), graph[i][j + 1].getWires().get(k).getCost());
                                graph[i][j + 1].add_edge(graph[i][j + 1].getWires().get(k), graph[i][j].getWires().get(k), graph[i][j].getWires().get(k).getCost());
                            }
                        }
                        else{
                             if (graph[i][j + 1].getWires().get(k-size_w).dir == 0) {
                                graph[i][j].add_edge(graph[i][j].getWires().get(k), graph[i][j + 1].getWires().get(k-size_w), graph[i][j + 1].getWires().get(k-size_w).getCost());
                                graph[i][j + 1].add_edge(graph[i][j + 1].getWires().get(k-size_w), graph[i][j].getWires().get(k), graph[i][j].getWires().get(k).getCost());
                            }
                        }
                    }
                }
